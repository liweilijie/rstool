...
// https://docs.rs/ed25519-dalek/latest/ed25519_dalek/ easy to understand
...
mod tests {
    ...
    fn test_process_text_sign() -> Result<()> {
        ...
        let sig_str = URL_SAFE_NO_PAD.encode(&sig);
        println!("sig: {sig_str}");
    ...
    fn test_process_text_verify() -> Result<()> {
        let mut reader = "hello".as_bytes();
        let format = TextSignFormat::Blake3;
        let sig = "XGfKeXTzM_XBps_UUtIz6uODEyaGAen-J3vvTMh_szo";
